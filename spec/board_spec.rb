  ...
  describe "#win_row?" do
    context "there is a consecutive row win condition" do
      it "returns true" do
        ...
        expect(subject.win_row?(1, "W", 0, 1)).to be(true)
    end
  end
    ...
    context "there is no column win condition" do  
      it "returns false" do
        ...
        expect(subject.win_row?(1,"W", 1, 0)).to be(false)
      end
    end
  end
    describe "win_diagonal_left?" do
      context "there is a consecutive left diagonal win condition" do
        it "returns true" do
          ...
          expect(subject.win_diagonal_left?(1, "W", 1, 1)).to be(true)
      end
    end
      ...
      context "there is no left diagonal win condition" do  
        it "returns false" do
          ...
          expect(subject.win_diagonal_left?(1,"W", 1, 1)).to be(false)
        end
      end
