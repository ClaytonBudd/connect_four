...
describe Board do
  ...
  describe "#win_row?" do
    context "there is a consecutive row win condition" do
      it "returns true" do
        ...
        expect(subject.win?([1,1], "W", 0, 1)).to be(true)
    end
  end
    ...
    context "there is no column win condition" do  
      it "returns false" do
        ...
        expect(subject.win?([1,1], "W", 1, 0)).to be(false)
      end
    end
  end
    describe "win_diagonal_left?" do
      ...
      context "there is a consecutive left diagonal win condition" do
        it "returns true" do
          ...
          expect(subject.win?([1,1], "W", 1, 1)).to be(true)
      end
    end
      ...
      context "there is no left diagonal win condition" do  
        it "returns false" do
          ...
          expect(subject.win?([1,1], "W", 1, 1)).to be(false)
        end
      end
      ...
      context "current is nil" do  
        it "returns false" do
          subject.nodes = {[1, 1]=>"[]", [2, 2]=>"[W]", [3, 3]=>"[W]", [4, 4]=>"[W]",[5, 5]=>"[ ]", [6, 6]=>"[ ]"}
          expect(subject.win?(nil, "W", 1, 1)).to be(false)
        end
      end
      ...
      context "there is a consecutive right diagonal win condition" do
        it "returns true" do
          ...
          expect(subject.win?([1,7], "W", 1, -1)).to be(true)
      end
    end
      ...
      context "there is no right diagonal win condition" do  
        it "returns false" do
          ...
          expect(subject.win?([1,7], "W", 1, -1)).to be(false)
        end
      end
  ...
  describe "#find_diagonal_start" do

    context "if the input node exists in a left diagonal" do
      it "returns the first node in the diagonal" do
        expect(subject.find_diagonal_start([4,4], subject.diagonal_left_heads, 1, 1)).to eq([1,1])
      end
    end

    context "if the input node exists in a right diagonal" do
      it "returns the first node in the diagonal" do
        expect(subject.find_diagonal_start([4,4], subject.diagonal_right_heads, 1, -1)).to eq([1,7])
      end
    end

    context "if the input node does not exist in a left diagonal" do
      it "returns nil" do
        expect(subject.find_diagonal_start([1,7], subject.diagonal_left_heads, 1, 1)).to be(nil)
      end
    end
    
    context "if the input node does not exist in a right diagonal" do
      it "returns nil" do
        expect(subject.find_diagonal_start([1,1], subject.diagonal_right_heads, 1,-1)).to be(nil)
      end
    end
  end
